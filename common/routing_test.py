...
a3 = "/currency_graph?drop-prev=True&message=Bla1Bla2Bla3"
...
assert p4.route == '/send'
assert p2.get_arg('drop-prev') == 'True'
assert p3.get_arg('drop-prev') == 'True'
assert p3.get_arg('message') == 'Bla1Bla2Bla3'
assert str(p1) == a1
assert str(p2) == a2
assert str(p3) == a3
assert str(p4) == a4
...
assert ParsedRoute(super_hard).get_arg("some_key") == initial_value
